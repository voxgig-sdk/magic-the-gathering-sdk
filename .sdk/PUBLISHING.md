...
|---|---|---|
| `ts/` | @voxgig-sdk/magic-the-gathering-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/magic-the-gathering-sdk \
      --repository voxgig-sdk/magic-the-gathering-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/magic-the-gathering-sdk` shows it, and
`npm trust revoke @voxgig-sdk/magic-the-gathering-sdk --id=<id>` removes it.
