...
// MagicTheGathering SDK utility: fetcher

class MagicTheGatheringFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; MagicTheGatheringSDK/1.0)';
    ...
    public static function call(MagicTheGatheringContext $ctx, string $fullurl, array $fetchdef): array
    {
