...
// MagicTheGathering SDK utility: param

require_once __DIR__ . '/../core/Helpers.php';

class MagicTheGatheringParam
{
    public static function call(MagicTheGatheringContext $ctx, mixed $paramdef): mixed
    {
        $point = $ctx->point;
        $spec = $ctx->spec;
        $match_val = $ctx->match;
        ...
        $akey = '';
        if ($point) {
            $alias_map = MagicTheGatheringHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'alias'));
            if ($alias_map) {
