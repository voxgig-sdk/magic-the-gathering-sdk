...
// MagicTheGathering SDK utility: result_basic

class MagicTheGatheringResultBasic
{
    public static function call(MagicTheGatheringContext $ctx): ?MagicTheGatheringResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof MagicTheGatheringError) ? $result->err->msg : (string)$result->err;
