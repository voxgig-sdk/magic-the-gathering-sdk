...
// MagicTheGathering SDK utility: make_options

class MagicTheGatheringMakeOptions
{
    ...
    public static function call(MagicTheGatheringContext $ctx): array
    {
        ...
        //
        // `MagicTheGatheringSchema::optspec()` is built from the model:
        ...
        $optspec = MagicTheGatheringSchema::optspec();
