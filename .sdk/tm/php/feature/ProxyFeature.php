...
// MagicTheGathering SDK proxy feature
...
class MagicTheGatheringProxyFeature extends MagicTheGatheringBaseFeature
{
    ...
    public function init(MagicTheGatheringContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (MagicTheGatheringContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
