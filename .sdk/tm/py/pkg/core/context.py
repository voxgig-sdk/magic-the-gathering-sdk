...
from projectname_sdk.core.control import MagicTheGatheringControl
...
class MagicTheGatheringContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = MagicTheGatheringControl()
        ...
        if isinstance(sp, MagicTheGatheringSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, MagicTheGatheringResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, MagicTheGatheringResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return MagicTheGatheringOperation({})
    ...
    def make_error(self, code, msg):
        return MagicTheGatheringError(code, msg, self)
