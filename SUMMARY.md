...
Results: Successful response with list of sets.
...
- Production API Server: `https://api.magicthegathering.io/v1`
...
- `magic-the-gathering_list`: List records for an entity. Supported entities: `card`, `set`.
- `magic-the-gathering_load`: Load one record for an entity. Supported entities: `card`.
