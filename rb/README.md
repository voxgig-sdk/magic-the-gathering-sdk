# MagicTheGathering Ruby SDK

The Ruby SDK for the MagicTheGathering API. Provides an entity-oriented interface using idiomatic Ruby conventions.
...
result, err = client.MagicTheGathering(nil).load(
  { "id" => "test01" }, nil
)
...
```
rb/
├── MagicTheGathering_sdk.rb       -- Main SDK module
