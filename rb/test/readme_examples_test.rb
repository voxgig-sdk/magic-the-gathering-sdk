...
#      offline in seeded test mode (MagicTheGatheringSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "MagicTheGathering_sdk.rb")
  SDK_CLASS = "MagicTheGatheringSDK"
  ...
  SDK_BASE = "MagicTheGathering_sdk"
