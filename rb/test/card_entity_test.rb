...
class CardEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set MAGICTHEGATHERING_TEST_CARD_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def card_basic_setup(extra)
  ...
  entid_env_raw = ENV["MAGICTHEGATHERING_TEST_CARD_ENTID"]
