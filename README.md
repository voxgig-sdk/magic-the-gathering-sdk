...
Access Magic: The Gathering card and set information through HTTPS endpoints.
...
This SDK exposes the API as a small set of **semantic entities** — Card and Set — that you
