...
The Golang SDK for the MagicTheGathering API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/magic-the-gathering-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/magic-the-gathering-sdk=../path/to/github.com/voxgig-sdk/magic-the-gathering-sdk
```
...
```
github.com/voxgig-sdk/magic-the-gathering-sdk/
...
The root package (`github.com/voxgig-sdk/magic-the-gathering-sdk`) re-exports everything needed
