...
const testSeed = `map[string]any{"entity": map[string]any{"card": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "set": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
