...
The Python SDK for the MagicTheGathering API. Provides an entity-oriented interface following Pythonic conventions.
...
result, err = client.MagicTheGathering(None).load(
    {"id": "test01"}, None
)
