# MagicTheGathering SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions MagicTheGatheringSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both MagicTheGatheringSDK(...) and MagicTheGatheringSDK.test(...) become
#      MagicTheGatheringSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "magicthegathering_sdk"
_SDK_CLASS = "MagicTheGatheringSDK"
