...
class MagicTheGatheringTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = MagicTheGatheringTestRunner.getenv("MAGIC_THE_GATHERING_TEST_LIVE")
        override = MagicTheGatheringTestRunner.getenv("MAGIC_THE_GATHERING_TEST_OVERRIDE")
        ...
        explain = MagicTheGatheringTestRunner.getenv("MAGIC_THE_GATHERING_TEST_EXPLAIN")
...
def entity_data(v):
    return MagicTheGatheringTestRunner.entity_data(v)
...
def live_client_options():
    return MagicTheGatheringTestRunner.live_client_options()
