...
from magicthegathering_sdk.utility import register

# Load features
from magicthegathering_sdk.feature.base_feature import MagicTheGatheringBaseFeature
from magicthegathering_sdk.features import _has_feature, _make_feature
...
class MagicTheGatheringSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = MagicTheGatheringUtility()
        self._utility = utility

        from magicthegathering_sdk.config import shared_config
    ...
    def get_utility(self):
        return MagicTheGatheringUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("MagicTheGatheringSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Card(self, data=None) -> "CardEntity":
        ...
        from magicthegathering_sdk.entity.card_entity import CardEntity
        return CardEntity(self, data)


    def Set(self, data=None) -> "SetEntity":
        """Entity factory: client.Set().list() / client.Set().load({"id": ...})."""
        from magicthegathering_sdk.entity.set_entity import SetEntity
