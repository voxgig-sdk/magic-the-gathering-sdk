# MagicTheGathering Lua SDK



The Lua SDK for the MagicTheGathering API — an entity-oriented client using Lua conventions.
...
GitHub release tag (`lua/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/magic-the-gathering-sdk/releases)),
...
| `colorIdentity` | `table` | Color identity of the card |
| `colors` | `table` | Array of card colors |
| `flavor` | `string` | Flavor text of the card |
| `id` | `string` | Unique identifier for the card |
| `imageUrl` | `string` | URL to the card image |
| `legalities` | `table` | Legality status in various formats |
...
```
lua/
├── magic-the-gathering_sdk.lua    -- Main SDK module
...
The main module (`magic-the-gathering_sdk`) exports the SDK constructor
