...
describe("CardEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set MAGIC_THE_GATHERING_TEST_CARD_ENTID JSON to run live")
      return
    end
...
function card_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("MAGIC_THE_GATHERING_TEST_CARD_ENTID")
  ...
  if env["MAGIC_THE_GATHERING_TEST_LIVE"] == "TRUE" then
  ...
  local live = env["MAGIC_THE_GATHERING_TEST_LIVE"] == "TRUE"
  return {
    client = client,
    data = entity_data,
