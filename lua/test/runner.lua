...
function runner.env_override(m)
  local live = runner.getenv("MAGICTHEGATHERING_TEST_LIVE")
  local override = runner.getenv("MAGICTHEGATHERING_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("MAGICTHEGATHERING_TEST_EXPLAIN")
