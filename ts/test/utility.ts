...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.MAGICTHEGATHERING_TEST_LIVE ||
    'TRUE' === process.env.MAGICTHEGATHERING_TEST_OVERRIDE
  ) {
  ...
  m.MAGICTHEGATHERING_TEST_EXPLAIN = process.env.MAGICTHEGATHERING_TEST_EXPLAIN || m.MAGICTHEGATHERING_TEST_EXPLAIN
