...
(0, node_test_1.describe)('CardDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.MagicTheGatheringSDK({
...
function liveScenariosActive() { return false && process.env.MAGIC_THE_GATHERING_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.MagicTheGatheringSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['MAGIC_THE_GATHERING_TEST_CARD_ENTID'];
    ...
    const client = new __1.MagicTheGatheringSDK({
        base: 'http://localhost:8080',
