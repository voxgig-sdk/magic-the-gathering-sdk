...
exports.MagicTheGatheringEntityBase = void 0;
const node_util_1 = require("node:util");
// TODO: needs Entity superclass
// `D` is the entity's typed data model (e.g. Advice); subclasses bind it via
// `class AdviceEntity extends MagicTheGatheringEntityBase<Advice>`.
class MagicTheGatheringEntityBase {
    name = '';
    name_ = '';
    Name = '';
    _client;
...
exports.MagicTheGatheringEntityBase = MagicTheGatheringEntityBase;
//# sourceMappingURL=MagicTheGatheringEntityBase.js.map