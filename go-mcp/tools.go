...
type Args struct {
	Entity string         `json:"entity" jsonschema:"card | set"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.MagicTheGatheringSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "magic-the-gathering_list",
		Description: "List records from MagicTheGathering. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "magic-the-gathering_load",
		Description: "Load a single record from MagicTheGathering. " +
...
func runOp(client *sdk.MagicTheGatheringSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.MagicTheGatheringSDK, name string) (sdk.MagicTheGatheringEntity, error) {
