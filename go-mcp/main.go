// Command MagicTheGathering-mcp is an MCP server exposing the MagicTheGathering
// SDK as MCP tools.
//
// Two tools are registered:
//
//	MagicTheGathering_list  — list records of an entity
//	MagicTheGathering_load  — load a single record of an entity
//
