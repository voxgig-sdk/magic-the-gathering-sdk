...
// MagicTheGathering SDK utility type

class MagicTheGatheringUtility
{
    ...
    public static function copy(MagicTheGatheringUtility $src): MagicTheGatheringUtility
    {
        $u = new MagicTheGatheringUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
