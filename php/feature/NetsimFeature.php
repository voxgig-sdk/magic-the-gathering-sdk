...
// MagicTheGathering SDK netsim feature
...
class MagicTheGatheringNetsimFeature extends MagicTheGatheringBaseFeature
{
    ...
    private function _simulate(MagicTheGatheringContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(MagicTheGatheringContext $ctx, array $applied): void
    {
        $client = $this->client;
