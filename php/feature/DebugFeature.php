...
// MagicTheGathering SDK debug feature
...
class MagicTheGatheringDebugFeature extends MagicTheGatheringBaseFeature
{
    ...
    private function _finish(MagicTheGatheringContext $ctx, bool $ok): void
    {
