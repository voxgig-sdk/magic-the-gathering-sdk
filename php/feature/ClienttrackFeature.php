...
// MagicTheGathering SDK clienttrack feature
...
class MagicTheGatheringClienttrackFeature extends MagicTheGatheringBaseFeature
{
    ...
    public function PostConstruct(MagicTheGatheringContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'MagicTheGathering-SDK';
