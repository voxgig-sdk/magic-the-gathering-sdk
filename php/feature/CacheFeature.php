...
// MagicTheGathering SDK cache feature
...
class MagicTheGatheringCacheFeature extends MagicTheGatheringBaseFeature
{
    ...
    private function _through(MagicTheGatheringContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
