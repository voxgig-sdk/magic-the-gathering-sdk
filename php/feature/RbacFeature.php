...
// MagicTheGathering SDK rbac feature
...
class MagicTheGatheringRbacFeature extends MagicTheGatheringBaseFeature
{
    ...
    private function _required(MagicTheGatheringContext $ctx): ?string
    {
    ...
    private function _reject(MagicTheGatheringContext $ctx, string $required): void
    {
    ...
    private function _track(MagicTheGatheringContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
