...
// MagicTheGathering SDK ratelimit feature
...
class MagicTheGatheringRatelimitFeature extends MagicTheGatheringBaseFeature
{
    ...
    private function _acquire(MagicTheGatheringContext $ctx): void
    {
    ...
    private function _track(MagicTheGatheringContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
