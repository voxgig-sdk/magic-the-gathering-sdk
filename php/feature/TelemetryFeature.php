...
// MagicTheGathering SDK telemetry feature
...
class MagicTheGatheringTelemetryFeature extends MagicTheGatheringBaseFeature
{
    ...
    private function _close(MagicTheGatheringContext $ctx, bool $ok): void
    {
