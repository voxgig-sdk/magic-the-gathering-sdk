...
// MagicTheGathering SDK timeout feature
...
class MagicTheGatheringTimeoutFeature extends MagicTheGatheringBaseFeature
{
    ...
    private function _with_timeout(MagicTheGatheringContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(MagicTheGatheringContext $_ctx, float $ms): void
    {
        $client = $this->client;
