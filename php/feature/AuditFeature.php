...
// MagicTheGathering SDK audit feature
...
class MagicTheGatheringAuditFeature extends MagicTheGatheringBaseFeature
{
    ...
    private function _emit(MagicTheGatheringContext $ctx, string $outcome): void
    {
