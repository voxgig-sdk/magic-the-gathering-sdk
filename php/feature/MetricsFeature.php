...
// MagicTheGathering SDK metrics feature
...
class MagicTheGatheringMetricsFeature extends MagicTheGatheringBaseFeature
{
    ...
    private function _record(MagicTheGatheringContext $ctx, bool $ok): void
    {
