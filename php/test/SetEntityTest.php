...
class SetEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set MAGIC_THE_GATHERING_TEST_SET_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function set_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("MAGIC_THE_GATHERING_TEST_SET_ENTID");
    ...
    $idmap_resolved = Helpers::to_map(
        $env["MAGIC_THE_GATHERING_TEST_SET_ENTID"]);
