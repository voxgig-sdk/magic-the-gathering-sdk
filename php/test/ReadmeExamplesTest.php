...
// MagicTheGathering SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (MagicTheGatheringSDK::test)
...
{
    private const SDK_CLASS = 'MagicTheGatheringSDK';
    ...
    private const SDK_BASE = 'magicthegathering_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../magicthegathering_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
