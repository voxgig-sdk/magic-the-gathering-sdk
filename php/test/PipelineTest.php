...
// MagicTheGathering SDK pipeline test
//
...
{
    private static function utility(): MagicTheGatheringUtility
    {
        return new MagicTheGatheringUtility();
    }
    ...
    private static function ctx(array $over = []): MagicTheGatheringContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new MagicTheGatheringContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new MagicTheGatheringOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof MagicTheGatheringError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new MagicTheGatheringOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = MagicTheGatheringMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new MagicTheGatheringOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = MagicTheGatheringMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new MagicTheGatheringOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = MagicTheGatheringMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new MagicTheGatheringSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = MagicTheGatheringMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new MagicTheGatheringResponse([]),
            'result' => new MagicTheGatheringResult([]),
        ]);
        [, $err] = MagicTheGatheringMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new MagicTheGatheringSpec([]),
            'response' => null,
            'result' => new MagicTheGatheringResult([]),
        ]);
        [, $err] = MagicTheGatheringMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new MagicTheGatheringSpec(['step' => 's']),
            'response' => new MagicTheGatheringResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new MagicTheGatheringResult([]),
        ]);
        [, $err] = MagicTheGatheringMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new MagicTheGatheringSpec(['step' => 's']),
            'response' => new MagicTheGatheringResponse(self::resp(200, ['v' => 1])),
            'result' => new MagicTheGatheringResult([]),
        ]);
        [, $err] = MagicTheGatheringMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new MagicTheGatheringSpec(['step' => 's']),
            'response' => new MagicTheGatheringResponse(self::resp(200, ['v' => 2])),
            'result' => new MagicTheGatheringResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        MagicTheGatheringMakeResponse::call($ctx);
    ...
    {
        $preset = new MagicTheGatheringResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new MagicTheGatheringSpec([]),
            'response' => new MagicTheGatheringResponse([]),
            'result' => new MagicTheGatheringResult([]),
        ...
        [$got, $err] = MagicTheGatheringMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new MagicTheGatheringResult([])]);
        [, $err] = MagicTheGatheringMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new MagicTheGatheringSpec([]), 'result' => null]);
        [, $err] = MagicTheGatheringMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new MagicTheGatheringSpec(['step' => 's']),
            'result' => new MagicTheGatheringResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new MagicTheGatheringOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = MagicTheGatheringMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new MagicTheGatheringSpec(['step' => 's']),
            'result' => new MagicTheGatheringResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new MagicTheGatheringOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = MagicTheGatheringMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new MagicTheGatheringResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new MagicTheGatheringSpec([]),
            'result' => new MagicTheGatheringResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = MagicTheGatheringMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = MagicTheGatheringMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new MagicTheGatheringError('boom', 'boom');
        $utility->fetcher = function (MagicTheGatheringContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new MagicTheGatheringSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = MagicTheGatheringMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (MagicTheGatheringContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = MagicTheGatheringMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(MagicTheGatheringResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        MagicTheGatheringMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (MagicTheGatheringContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new MagicTheGatheringSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = MagicTheGatheringMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new MagicTheGatheringResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new MagicTheGatheringSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = MagicTheGatheringMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = MagicTheGatheringMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = MagicTheGatheringMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new MagicTheGatheringResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, MagicTheGatheringDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new MagicTheGatheringResult(['ok' => false])]);
        $this->expectException(MagicTheGatheringError::class);
        MagicTheGatheringDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new MagicTheGatheringResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', MagicTheGatheringMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        MagicTheGatheringMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new MagicTheGatheringBaseFeature();
        $b = new MagicTheGatheringBaseFeature();
        MagicTheGatheringFeatureAdd::call($ctx, $a);
        MagicTheGatheringFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): MagicTheGatheringBaseFeature
    {
        $f = new MagicTheGatheringBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        MagicTheGatheringFeatureAdd::call($ctx, self::named_feature('a'));
        MagicTheGatheringFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        MagicTheGatheringFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        MagicTheGatheringFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        MagicTheGatheringFeatureAdd::call($ctx, $replace);
        ...
        MagicTheGatheringFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): MagicTheGatheringContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new MagicTheGatheringSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = MagicTheGatheringPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        MagicTheGatheringPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new MagicTheGatheringResponse(['headers' => null]),
            'result' => new MagicTheGatheringResult([]),
        ]);
        MagicTheGatheringResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        MagicTheGatheringResultBody::call($ctx);
