...
// MagicTheGathering SDK utility: graphql
//
...
class MagicTheGatheringGraphql
{
    ...
    // equivalent.
    public static function body(MagicTheGatheringContext $ctx): mixed
    {
    ...
    public static function errors(MagicTheGatheringContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
