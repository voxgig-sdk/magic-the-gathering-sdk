...
// MagicTheGathering SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class MagicTheGatheringMakeRequest
{
    public static function call(MagicTheGatheringContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new MagicTheGatheringResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new MagicTheGatheringResponse($fetched);
        } else {
