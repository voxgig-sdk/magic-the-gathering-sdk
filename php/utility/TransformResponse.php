...
// MagicTheGathering SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class MagicTheGatheringTransformResponse
{
    public static function call(MagicTheGatheringContext $ctx): mixed
    {
        ...
        $transform = MagicTheGatheringHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
