...
func registerSDKWords(r *eng.Registry, client *sdk.MagicTheGatheringSDK) {
...
func runOp(client *sdk.MagicTheGatheringSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
