...
AQL-driven CLI and REPL for the MagicTheGathering SDK. Positional arguments are
...
```sh
go build -o magic-the-gathering-cli ./...
```
...
./magic-the-gathering-cli load 1 card
./magic-the-gathering-cli load '{id:1}' card
